package com.formacionjava.springmvc.controlador;
...
import com.formacionjava.springmvc.servicios.EmpleadoServicio;
...
public class EmpleadoControlador {
	...
	public String listarTrabajadores(Model modelo) {
		...
		modelo.addAttribute("empleado", servicio.listarTodosLosTrabajadores());
		return "empleado";
	}
